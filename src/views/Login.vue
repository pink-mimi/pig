<template>
  <div class="log_box">
    ...
    <div class="top_wrap"><router-link to="/signin" >注册</router-link></div>
    <div class="top_logo">
      <img
    ...
    <div>
      <div class="tab_nav">
        <span class="common logo" :class="{active:num==1}" @click="fn1">普通登录</span>
        <span class="note logo" :class="{active:num==2}" @click="fn2">短信快捷登录</span>
      </div>
